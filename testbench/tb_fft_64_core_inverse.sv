...
initial begin
    ...
    testname = "Single Frequency Inverse";
    stream_frame_from_file(1'b0, "testdata/ifft_test_sine_real.txt", "testdata/ifft_test_sine_imag.txt");
    
    testname = "Single Phasor Inverse";
    stream_frame_from_file(1'b0, "testdata/ifft_test_phasor_real.txt", "testdata/ifft_test_phasor_imag.txt");
